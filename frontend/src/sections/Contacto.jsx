      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {mostrarBloqueProveedores && (
          <div className="mt-16">
            <ActionSection
              isProveedores={true}
              icon={<Heart size={28} className="text-[#fcd34d]" />}
              title={({ accentFrom, accentTo }) => (
                <>¿Eres <span className="text-transparent bg-clip-text" style={{ backgroundImage: `linear-gradient(to right, ${accentFrom}, ${accentTo})` }}>proveedor o aliado</span> estratégico?</>
              )}
              description="Si tienes productos o servicios que encajen con nuestra oferta, cuéntanos y evaluamos trabajar juntos."
              buttonLabel="Quiero unirme"
              buttonHref={`https://wa.me/${WHATSAPP}?text=Hola, quiero unirme a su red de proveedores`}
